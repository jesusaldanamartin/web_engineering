...
def inserts():
    ...
    accion1 = Tabla_Medico(id_robot="0", name_robot="Robot-A", id_Tareas="100", estado="Disponible",tipoTarea="Limpieza", tipoTareaAsignada="Limpieza pasillo", tiempoEstimado= 0.01 )
